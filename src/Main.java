...
//public class RomanArabianCalc { // как было public class RomanArabianCalc - класс так назывался
public class Main { // Исправленное на Main класс
    static Scanner scanner = new Scanner(System.in);
    static int number1, number2;
    static char operation;
    static int result;

    public static void main (String calc []) { // Как стало исправленое
        // public static void main (String[] args) { Как было до исправления
